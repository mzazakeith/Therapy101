    ...
    function TimePicker(props) {
        ...
        _this.renderTimePicker = function (locale) {
            ...
            var inputIcon = React.createElement(
                ...
                React.createElement(Icon, { type: 'clock-circle-o', className: props.prefixCls + '-clock-icon' })
            );
            var clearIcon = React.createElement(Icon, { type: 'close-circle', className: props.prefixCls + '-panel-clear-btn-icon' });
